...
Nova.booting(function (Vue, router, store) {
    Vue.component('index-product-variants', __webpack_require__(3));
    Vue.component('detail-product-variants', __webpack_require__(6));
    Vue.component('form-product-variants', __webpack_require__(9));
});
...
var render = function() {
  ...
  return _c("span", [_vm._v(_vm._s(_vm.field.attributes))])
}
var staticRenderFns = []
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        fill: function fill(formData) {
            ...
            if (this.variants[this.defaultPicked]) this.variants[this.defaultPicked].default = true;
                    ...
                    while (1) {
                        switch (_context.prev = _context.next) {
                            ...
                            case 2:
                                ...
                                _context.next = 5;
                                return this.options.push({ category: attributes[i].name, opts: [] });

                            case 5:
                                j = 0;

                            case 6:
                                if (!(j < attributes[i].options.length)) {
                                    _context.next = 12;
                                    break;
                                }

                                _context.next = 9;
                                return this.options[i].opts.push({ option_name: attributes[i].options[j].name,
        ...
        generate: function generate() {
            var tmpVariants = this.groupBy(this.variantsSelect, 'attribute_id');
            var filteredVariants = tmpVariants.filter(function (variant) {
                return !(Object.keys(variant).length === 0);
            });
            var variantsGenerated = this.generateVariants(filteredVariants);
        ...
        generateVariants: function generateVariants(variants) {
            var r = [],
                max = variants.length - 1;
            if (max < 0) return [];

            function helper(arr, i) {
                for (var j = 0, l = variants[i].length; j < l; j++) {
                    var a = arr.slice(0);
                    a.push(variants[i][j]);
        ...
        initializeVariants: function initializeVariants(variants) {
            var dataVariants = [];
        ...
        deleteVariant: function deleteVariant(index) {
...
var render = function() {
  ...
  return _c(
    ...
    [
        ...
        [
          _c("template", { slot: "field" }, [
            _c(
              ...
              {
                staticClass:
                  "nova-items-field-input-wrapper w-full flex border border-40 p-4"
              },
              [
                _c(
                  "multiselect",
                  {
                    ...
                    model: {
                      value: _vm.variantsSelect,
                      callback: function($$v) {
                        _vm.variantsSelect = $$v
                      },
                      expression: "variantsSelect"
                    }
                  },
                  [
      ...
      _vm._v(" "),
      _c("div", { staticClass: "w-full flex justify-center pt-5 pb-5" }, [
          ...
          ? _c(
              ...
              [
                _c(
                  "table",
                  {
                    staticClass: "table w-full table-undefined",
                    attrs: {
                      cellpadding: "0",
                      cellspacing: "0",
                  ...
                  [
                    ...
                    _c(
                      ...
                      _vm._l(_vm.variants, function(variant, index) {
                        return _c(
                          "tr",
                          { key: index, attrs: { dusk: "2-row" } },
                          [
                            _c("td", { staticClass: "text-center" }, [
                              _c("span", { staticClass: "text-left" }, [
                                _c("label", { staticClass: "contenedor" }, [
                                  _c("input", {
                                    directives: [
                                      {
                                        name: "model",
                                        rawName: "v-model",
                                        value: _vm.defaultPicked,
                                        expression: "defaultPicked"
                                      }
                                    ],
                                    attrs: {
                                      type: "radio",
                                    ...
                                    domProps: {
                                      value: index,
                                      checked: _vm.variants[index].default,
                                      checked: _vm._q(_vm.defaultPicked, index)
                                    },
                                    on: {
                                      change: function($event) {
                                        _vm.defaultPicked = index
                                      }
                                    }
                                  }),
                                  _vm._v(" "),
                            ...
                            _c(
                              "td",
                              _vm._l(variant.options, function(
                                option,
                                indexOpt
                              ) {
                                return _c(
                                  "span",
                                  { key: indexOpt, staticClass: "text-left" },
                                  [
                                    _vm._v(
                                      _vm._s(option.attribute_name) +
                                        ": " +
                                  ...
                                  directives: [
                                    {
                                      name: "model",
                                      rawName: "v-model",
                                      value: _vm.variants[index].normal_price,
                                      expression: "variants[index].normal_price"
                                    }
                                  ],
                                  staticClass:
                                  ...
                                  directives: [
                                    {
                                      name: "model",
                                      rawName: "v-model",
                                      value: _vm.variants[index].price_tax,
                                      expression: "variants[index].price_tax"
                                    }
                                  ],
                                  staticClass:
                                    "w-full form-control form-input form-input-bordered",
                                  ...
                                  directives: [
                                    {
                                      name: "model",
                                      rawName: "v-model",
                                      value: _vm.variants[index].discount,
                                      expression: "variants[index].discount"
                                    }
                                  ],
                                  staticClass:
                                    "w-full form-control form-input form-input-bordered",
                                    ...
                                    _c("span", { staticClass: "inline-flex" }, [
                                      _c(
                                        "a",
                                        {
                                          ...
                                          on: {
                                            click: function($event) {
                                              return _vm.deleteVariant(index)
                                            }
                                          }
                                        },
                                        [
  ...
  function() {
    ...
    return _c("thead", [
      _c("tr", [
        ...
        _vm._v(" "),
        _c("th", { staticClass: "text-left" }, [
          _c("span", [_vm._v("Precio + IVA")])
        ]),
        _vm._v(" "),
        _c("th", { staticClass: "text-left", attrs: { colspan: "2" } }, [
          _c("span", [_vm._v("Precio con descuento")]),
          _vm._v(" "),
          _c("div", { staticClass: "help-text lowercase" }, [
            _vm._v("(0 en caso de que no aplique)")
          ])
        ])
      ])
    ])
