...
Nova.booting(function (Vue, router, store) {
    Vue.component('index-StringLimit', __webpack_require__(3));
    Vue.component('detail-StringLimit', __webpack_require__(6));
    Vue.component('form-StringLimit', __webpack_require__(9));
});
        ...
        _c("p", { staticClass: "my-2 text-80" }, [
          _vm._v(
            "\n            " +
              ...
              " " +
              _vm._s(_vm.__("characters remaning")) +
              "\n        "
          )
        ])
      ])
