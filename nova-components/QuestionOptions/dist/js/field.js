...
Nova.booting(function (Vue, router, store) {
    Vue.component('index-question-options', __webpack_require__(3));
    Vue.component('detail-question-options', __webpack_require__(6));
    Vue.component('form-question-options', __webpack_require__(9));
});
...
var render = function() {
  ...
  return _c("div", { staticClass: "flex border-b border-40" }, [
    ...
    _c(
      ...
      _vm._l(Object.values(JSON.parse(_vm.field.value)), function(option) {
        return _c(
          "button",
          { staticClass: "btn btn-primary btn-default mr-5" },
          [_vm._v("\n            " + _vm._s(option.name) + "\n        ")]
        )
      }),
      0
...
var staticRenderFns = [
  function() {
    ...
    return _c("div", { staticClass: "w-1/4 py-4" }, [
      _c("h4", { staticClass: "font-normal text-80" }, [_vm._v("Opciones")])
    ])
  }
]
render._withStripped = true
          ...
          _c(
            ...
            [
              _c("input", {
                ...
                staticClass:
                  "w-full form-control form-input form-input-bordered rounded border-r",
                attrs: { type: "text", placeholder: _vm.__("New option") },
              ...
              _c(
                "button",
                {
                  staticClass: "btn btn-default btn-primary rounded",
                  attrs: { type: "button" },
                  on: {
          ...
          _vm._l(Object.keys(_vm.options), function(key) {
            return _c("div", { staticClass: "flex mt-5" }, [
                ...
                directives: [
                  {
                    name: "model",
                    rawName: "v-model",
                    value: _vm.options[key].name,
                    expression: "options[key].name"
                  }
                ],
                staticClass:
                  "w-full form-control form-input form-input-bordered rounded border-r",
                attrs: { type: "text", placeholder: _vm.__("Option") },
                domProps: { value: _vm.options[key].name },
                on: {
                  input: function($event) {
                    if ($event.target.composing) {
                      return
                    }
                    _vm.$set(_vm.options[key], "name", $event.target.value)
                  }
                }
              }),
              _vm._v(" "),
              _c(
                "button",
                {
                  staticClass: "btn btn-default btn-danger rounded",
                  attrs: { type: "button" },
                  on: {
                    click: function($event) {
