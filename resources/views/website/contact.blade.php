    ...
    <section class="relative bg-white xs:pt-16 pb-20 xs:px-8 md:pt-32">
        <div class="relative max-w-7xl mx-auto">
            <div class="md:px-24">
                <div class="flex justify-center">
                    <div class="w-full text-center">
                        <h1
                        class="text-3xl font-bold uppercase text-primary md:text-5xl leading-normal tracking-wide"
                        >Envíos a todo el país</h1>
                        <h2
                        class="text-3xl  text-secondary-100 tracking-tighter font-bold  leading-snug uppercase"
                        >Prueba Nuestro cotizador express</h2>
                    </div>
                </div>
            </div>
            ...
            <div class="mt-12 max-w-lg mx-auto flex flex-col md:flex-row justify-between items-center fadeIn md:space-x-5">
                <div class="flex-1">
                    <img src="/img/tecnotanques/contactanos-proproyectos-min.png" alt="Contactanos Proproyectos">
                </div>
                <div class="flex-1">
