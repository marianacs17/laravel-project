                ...
                <div class="block-grid"
                    ...
                    <div style="border-collapse: collapse;display: table;width: 100%;background-color:#1aa19c;">
                        ...
                        <td align="center" width="640"
                            style="background-color:#1aa19c;width:640px; border-top: 0px solid transparent; border-left: 0px solid transparent; border-bottom: 0px solid transparent; border-right: 0px solid transparent;"
                            valign="top">
                        <table width="100%" cellpadding="0" cellspacing="0" border="0">
                            <tr>
                                        ...
                                        <tr style="vertical-align: top;" valign="top">
                                            <td class="divider_inner"
                                                ...
                                                <table align="center" border="0" cellpadding="0" cellspacing="0"
                                                       ...
                                                       style="table-layout: fixed; vertical-align: top; border-spacing: 0; border-collapse: collapse; mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-top: 4px solid #FF7006; width: 100%;"
                                                       valign="top" width="100%">
                                                    <tbody>
                                                    <tr style="vertical-align: top;" valign="top">
                                    ...
                                    <div
                                        ...
                                        <div
                                            ...
                                            <p style="font-size: 30px; line-height: 1.2; text-align: center; word-break: break-word; mso-line-height-alt: 36px; margin: 0;">
                                                <span
                                                    style="font-size: 30px; color: #2b303a;"><strong>Nueva solicitud de contacto</strong></span>
                                            </p>
                                        </div>
                                    </div>
                                    <!--[if mso]></td></tr></table><![endif]-->
                                    ...
                                    <div
                                        ...
                                        <div
                                            ...
                                            <p style="font-size: 15px; line-height: 1.5; text-align: center; word-break: break-word; font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif; mso-line-height-alt: 23px; margin: 0;">
                                                <span style="color: #808389; font-size: 15px; text-center">

                                                    Se generó una nueva solicitud de cotización desde el sitio:

                                                    <ul class="text-center">

                                                        @foreach(collect($contact) as $key => $value)
                                                            <li>
                                                                @if($key === 'name')
                                                                    Nombre : {{ $contact[$key] }}
                                                                @elseif($key === 'email')
                                                                    Correo : {{ $contact[$key] }}
                                                                @elseif($key === 'phone')
                                                                    Telefono : {{ $contact[$key] }}
                                                                @elseif($key === 'cellphone')
                                                                    Celular : {{ $contact[$key] }}
                                                                @elseif($key === 'shipping_place')
                                                                    Lugar de envio : {{ $contact[$key] }}
                                                                @elseif($key === 'capacity')
                                                                    Capacidad : {{ $contact[$key] }}
                                                                @elseif($key === 'substance_to_store')
                                                                    Sustancia a almacenar : {{ $contact[$key] }}
                                                                @elseif($key === 'product')
                                                                    Producto : {{ $contact[$key] }}
                                                                @elseif($key === 'quantity')
                                                                    Cantidad : {{ $contact[$key] }}
                                                                @elseif($key === 'sector')
                                                                    Sector : {{ $contact[$key] }}
                                                                @elseif($key === 'message')
                                                                    Mensaje : {{ $contact[$key] }}
                                                                @elseif($key === 'updated_at')
                                                                    Actualizada el : {{ $contact[$key] }}
                                                                @elseif($key === 'created_at')
                                                                    Creada el : {{ $contact[$key] }}
                                                                @else
                                                                    {{ $key }} : {{ $contact[$key] }}
                                                                @endif
                                                            </li>
                                        ...
                                        <tr>
                                            <td style="padding-top: 15px; padding-right: 10px; padding-bottom: 0px; padding-left: 10px"
                                                ...
                                                <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml"
                                                             ...
                                                             style="height:46.5pt; width:189.75pt; v-text-anchor:middle;"
                            ...
                            <div class="col_cont" style="width:100% !important;">
                                ...
                                <div
                                    ...
                                    <div
                                        ...
                                        <div
                                            style="line-height: 1.5; font-size: 12px; font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif; color: #555555; mso-line-height-alt: 18px;">
                                            <p style="font-size: 12px; line-height: 1.5; word-break: break-word; text-align: left; font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif; mso-line-height-alt: 18px; margin: 0;">
                                                <span style="color: #95979c; font-size: 12px;">
                                                    Este correo es informativo y tiene la finalidad de generar cotizaciones de una manera rápida para los usuarios,
                                                    es recomendable asignarle un asesor de inmediato
                                                </span>
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div
                                        ...
                                        <div
                                            ...
                                            <p style="font-size: 12px; line-height: 1.2; word-break: break-word; text-align: left; font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif; mso-line-height-alt: 14px; margin: 0;">
                                                <span style="color: #95979c; font-size: 12px;">Proproyectos.com</span>
                                            </p>
                                        </div>
                                    </div>
                                    <!--[if mso]></td></tr></table><![endif]-->
